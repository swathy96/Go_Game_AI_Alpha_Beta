...
if __name__ == "__main__":
    ...
    for i in range(15):
        go_board = GO(5)
        go_board.init_board(5)
        random_player = RandomPlayer()
        alpha_beta_player = AlphaBetaAgent()
        go_board.play(alpha_beta_player,random_player,True)
        result = go_board.judge_winner()
        if result == 1:
            count+=1
    print("Total Win = "+str(count))
